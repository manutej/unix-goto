...
echo "   source $REPO_DIR/goto.sh"
echo ""
echo "💾 Or for permanent installation:"
echo "   echo 'source $REPO_DIR/goto.sh' >> $SHELL_CONFIG"
echo "   source $SHELL_CONFIG"
echo ""
echo "Try it out:"
echo "  goto index rebuild    # Build cache"
echo "  goto index status     # See cache stats"
echo "  goto --help           # See all commands"
echo ""
echo "Customize search paths in: lib/goto-function.sh (search for 'search_paths')"
